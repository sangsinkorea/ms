...
const ThumbnailGenerator: React.FC<Props> = ({ apiKey, baseUrl }) => {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const url = await generateThumbnail(productName, features, customInstructions, refImage, apiKey, baseUrl);
